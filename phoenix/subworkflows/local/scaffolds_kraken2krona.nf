...
//
include { SCAFFOLDS_KRAKEN2 as KRAKEN2_TRIMD                  } from '../../modules/local/scaffolds_kraken2'
include { SCAFFOLDS_KRAKEN2 as KRAKEN2_ASMBLD                 } from '../../modules/local/scaffolds_kraken2'
include { SCAFFOLDS_KRAKEN2 as KRAKEN2_WTASMBLD               } from '../../modules/local/scaffolds_kraken2'
