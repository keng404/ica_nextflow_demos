process MAKE_VARIANTS_LONG_TABLE {
    ...
    memory '48 GB'
    input:
    path ("${params.outdir}/bcftools_query/*")
    path ("${params.outdir}/snpsift/*")
    ...
    """
    python ${workflow.launchDir}/bin/make_variants_long_table.py \\
        --bcftools_query_dir ${workflow.launchDir}/${params.outdir}/bcftools_query \\
        --snpsift_dir ${workflow.launchDir}/${params.outdir}/snpsift \\
        --pangolin_dir ${workflow.launchDir}/${params.outdir}/pangolin \\
        $args
