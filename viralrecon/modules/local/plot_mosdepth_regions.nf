process PLOT_MOSDEPTH_REGIONS {
	publishDir  path: { "${params.outdir}/regionsmosdepthplot"}, mode: "copy", saveAs: { filename -> filename.equals('versions.yml') ? null : filename }
...
memory '48 GB'
    ...
    def args = task.ext.args ?:  '--input_suffix .regions.bed.gz'
