...
include { MULTIQC  } from '../modules/local/multiqc_illumina.nf'
include { PLOT_MOSDEPTH_REGIONS as PLOT_MOSDEPTH_REGIONS_GENOME   } from '../modules/local/plot_mosdepth_regions.nf'
include { PLOT_MOSDEPTH_REGIONS as PLOT_MOSDEPTH_REGIONS_AMPLICON } from '../modules/local/plot_mosdepth_regions.nf'
include { MULTIQC_TSV_FROM_LIST as MULTIQC_TSV_FAIL_READS         } from '../modules/local/multiqc_tsv_from_list.nf'
include { MULTIQC_TSV_FROM_LIST as MULTIQC_TSV_FAIL_MAPPED        } from '../modules/local/multiqc_tsv_from_list.nf'
include { MULTIQC_TSV_FROM_LIST as MULTIQC_TSV_NEXTCLADE          } from '../modules/local/multiqc_tsv_from_list.nf'
//
// SUBWORKFLOW: Consisting of a mix of local and nf-core/modules
//
include { INPUT_CHECK         } from '../subworkflows/local/input_check.nf'
include { PREPARE_GENOME      } from '../subworkflows/local/prepare_genome_illumina.nf'
include { VARIANTS_IVAR       } from '../subworkflows/local/variants_ivar.nf'
include { VARIANTS_BCFTOOLS   } from '../subworkflows/local/variants_bcftools.nf'
include { CONSENSUS_IVAR      } from '../subworkflows/local/consensus_ivar.nf'
include { CONSENSUS_BCFTOOLS  } from '../subworkflows/local/consensus_bcftools.nf'
include { VARIANTS_LONG_TABLE } from '../subworkflows/local/variants_long_table.nf'
include { ASSEMBLY_SPADES     } from '../subworkflows/local/assembly_spades.nf'
include { ASSEMBLY_UNICYCLER  } from '../subworkflows/local/assembly_unicycler.nf'
include { ASSEMBLY_MINIA      } from '../subworkflows/local/assembly_minia.nf'
/*
========================================================================================
...
include { PICARD_COLLECTMULTIPLEMETRICS } from '../modules/nf-core/modules/picard/collectmultiplemetrics/main.nf'
include { CUSTOM_DUMPSOFTWAREVERSIONS   } from '../modules/nf-core/modules/custom/dumpsoftwareversions/main.nf'
include { MOSDEPTH as MOSDEPTH_GENOME   } from '../modules/nf-core/modules/mosdepth/main.nf'
include { MOSDEPTH as MOSDEPTH_AMPLICON } from '../modules/nf-core/modules/mosdepth/main.nf'
//
// SUBWORKFLOW: Consisting entirely of nf-core/modules
//
include { FASTQC_FASTP           } from '../subworkflows/nf-core/fastqc_fastp.nf'
include { ALIGN_BOWTIE2          } from '../subworkflows/nf-core/align_bowtie2.nf'
include { PRIMER_TRIM_IVAR       } from '../subworkflows/nf-core/primer_trim_ivar.nf'
include { MARK_DUPLICATES_PICARD } from '../subworkflows/nf-core/mark_duplicates_picard.nf'
/*
========================================================================================
    RUN MAIN WORKFLOW
========================================================================================
...
println("Reinitializing KRAKEN2 DB is here: " +  params.kraken2_db)
workflow ILLUMINA {
...
if (!params.skip_mosdepth) {
    ...
    if (!params.skip_variants && !params.skip_variants_long_table && params.gff && !params.skip_snpeff) {
        if(variant_caller == "bcftools"){
            process.ext.args = "-H -f '%CHROM\\t%POS\\t%REF\\t%ALT\\t%FILTER\\t[%DP\\t]\\t[%AD\\t]\\n'"
        }
        if(variant_caller == "ivar"){
            process.ext.args = "-H -f '%CHROM\\t%POS\\t%REF\\t%ALT\\t%FILTER\\t[%DP\\t]\\t[%REF_DP\\t]\\t[%ALT_DP\\t]\\n'"
        }
        VARIANTS_LONG_TABLE (
            ch_vcf,
            ch_tbi,
...
if (params.protocol == 'amplicon' && !params.skip_cutadapt) {
    process.ext.args = '--overlap 5 --minimum-length 30 --error-rate 0.1'
}
        CUTADAPT (
            ch_assembly_fastq,
...
if ('minia' in assemblers) {
    process.ext.args = '-kmer-size 31 -abundance-min 20'
}
        ASSEMBLY_MINIA (
            ch_assembly_fastq,
            PREPARE_GENOME.out.fasta,
