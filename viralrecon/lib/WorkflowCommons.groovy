...
class WorkflowCommons {
    ...
    public static String paramsSummaryMultiqc(workflow, summary) {
        ...
        String yaml_file_text  = "id: 'viralrecon-summary'\n"
        yaml_file_text        += "description: ' - this information is collected when the pipeline is started.'\n"
        yaml_file_text        += "section_name: 'viralrecon-summary Workflow Summary'\n"
        yaml_file_text        += "section_href: 'https://github.com/nf-core/viralrecon'\n"
